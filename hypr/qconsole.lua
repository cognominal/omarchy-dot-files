-- Local copy of /usr/share/omarchy/default/hypr/qconsole.lua with share = 1.0,
-- so the scratchpad covers the whole screen. Loaded in place of Omarchy's
-- through package.preload in hyprland.lua; Omarchy updates to the original
-- will not reach this copy.
